...
router.put('/', upload.single('manga_bg_img'), async (req, res) => {
  const { id, manga_id, manga_name, manga_disc, manga_slug, tag_id } = req.body;
  const mangaId = id || manga_id;
...
// Update Manga by ID in path (with Image Upload)
